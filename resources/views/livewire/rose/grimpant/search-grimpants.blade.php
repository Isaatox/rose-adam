<div class="container" style="margin-bottom: 5rem !important; margin-top: 6rem !important">
    <input type="text" class="form-control" style="border-radius: 1rem !important"
        placeholder="Rechercher une variété de Rosiers grimpants ..." wire:model="searchRoses" />
    <div class="mb-5 mt-5">
        ...
        <a href="/roses/grimpants" class="btn btn-info mt-2">Nos Rosiers Grimpants</a>
