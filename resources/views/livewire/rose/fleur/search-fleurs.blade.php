<div class="container" style="margin-bottom: 5rem !important; margin-top: 6rem !important">
    <input type="text" class="form-control" style="border-radius: 1rem !important"
        placeholder="Rechercher une variété de Rosiers à fleurs groupées ..." wire:model="searchRoses" />
    <div class="mb-5 mt-5">
        ...
        <a href="/roses/fleurs-groupées" class="btn btn-info mt-2">Nos Rosiers à fleurs groupées</a>
    ...
    <h2>Nos Rosiers à fleurs groupées</h2>
