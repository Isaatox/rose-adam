...
@section('content')
    ...
    <div class="container" style="margin-bottom: 5rem !important; margin-top: 6rem !important">
        <div class="row searchFilter">
            <div class="col-sm-12">
                <form action="{{ url('/roses/search') }}" method="post">
                    {!! csrf_field() !!}
                    <div class="input-group">
                        <input class="form-control" id="form1" type="text" name="search"
                            placeholder="Rechercher une espèce de Rose ..." style="border-radius: 1rem !important">
    ...
    <div class="container" style="margin-bottom: 5rem !important; margin-top: 6rem !important">
        <h2>Nos Roses</h2>
        <p class="float-right">{{ $nbrroses }} résultat</p>
        @if (!empty($recherche))
